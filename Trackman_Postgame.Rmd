...
<div class="custom-header">
  <h1>Ben Smith Scrimmage 10-27</h1>
...
SeasondfPitcher <- dfm %>% filter(Pitcher == "Ben Smith")
dfStuff <- read_csv("combined_stuff_location.csv") %>% filter(Pitcher == "Ben Smith" & Date == "10/27/2024")
dfp <- read_csv("2025Season_CSV.csv") 
dfPitcher <- dfp %>%  filter(Pitcher == "Ben Smith") %>% 
  mutate(
